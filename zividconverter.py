...
# Add Zivid SDK to path
zivid_bin_path = r"C:\Program Files\Zivid\bin"
if os.path.exists(zivid_bin_path):
    sys.path.insert(0, zivid_bin_path)
    os.add_dll_directory(zivid_bin_path)
import argparse
